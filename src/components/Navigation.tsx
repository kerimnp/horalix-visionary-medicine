...
export function Navigation() {
  ...
  return (
    <nav
      className={cn(
        "fixed top-0 left-0 right-0 z-50 transition-all duration-700 ease-in-out h-16",
      ...
      <div className="container mx-auto px-6 h-full flex items-center justify-between">
        <div className="flex items-center space-x-2">
          <img 
            ...
            alt="Horalix Logo" 
            className="h-7 w-auto animate-fade-in hover:scale-110 transition-all duration-500 ease-in-out"
          />
        </div>
        <div className="flex items-center space-x-2">
          <LanguageSelector />
          <div className="hidden md:flex items-center space-x-6">
            {[
              ...
              <button
                ...
                className="text-sm text-medical-deep/80 hover:text-medical-deep transition-all duration-500 ease-in-out relative group"
              >
                {label}
          ...
          <button
            ...
            className="premium-button text-sm py-2"
          >
